...
public class SearchEngine implements Constants {
	...
	public static HashMap<String, Integer> search(String input1) {
		...
		try {
			...
			// System.out.println("Reading the trie and Index table from files");
			TST<Integer> tst = (TST<Integer>) FileOperations.ReadObjectFromFile(triePath);
			InvertedIndex invertedIndex = (InvertedIndex) FileOperations.ReadObjectFromFile(indexTablePath);
			// Auto Correction
